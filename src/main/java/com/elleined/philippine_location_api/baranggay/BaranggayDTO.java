...
public record BaranggayDTO(@Column("id") @JsonProperty("id") Long id,
                           ...
                           @Column("province_name") @JsonProperty("province_name") String provinceName,
                           @Column("city_id") @JsonProperty("city_id") Long cityId,
                           @Column("city_name") @JsonProperty("city_name") String cityName) implements Serializable {
}
