DROP FUNCTION IF EXISTS province_find_all_by_total;
DELIMITER //
CREATE FUNCTION IF NOT EXISTS province_find_all_by_total(
    region_id BIGINT,
    name VARCHAR(50)
)
RETURNS INT DETERMINISTIC
COMMENT 'Get the total elements of province_find_all_by'
BEGIN
